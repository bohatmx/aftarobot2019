...
export class DriverMarshalCampaignSummaryDTO {
  ...
  instance(data) {
    console.log(
      "## setting up instance of: DriverMarshalCampaignSummaryDTO object"
    );
...
export class RouteBuilderLocationRequestDTO {
  ...
  instance(data) {
    console.log(
      "## setting up instance of: RouteBuilderLocationRequestDTO object"
    );
...
export class RouteBuilderLocationResponseDTO {
  ...
  instance(data) {
    console.log(
      "## setting up instance of: RouteBuilderLocationResponseDTO object"
    );
