...
public class BeaconScanner {
    ...
    public static void scanBeacons(Context ctx, final EventChannel.EventSink events) throws Exception {
        ...
        Log.w(TAG, "\n\n+++ ️ℹ️️ℹ️️ℹ️ BeaconScanner :: scanBeacons: $$$$$$$$$$$$$$$$$$$$$ " +
        ...
        scanCallback = new ScanCallback() {
            ...
            public void onScanResult(int callbackType, ScanResult result) {
                Log.d(TAG, "++++ ️ℹ️ we have a ScanResult ✅  +++++++++ power level: " +
                ...
                Log.i(TAG, "onScanResult: ️ℹ️ advertiseId: ".concat(advertiseId));
                ...
                if (!beaconHashMap.containsKey(beaconID)) {
                    beaconHashMap.put(estimoteBeacon.getBeaconName(), estimoteBeacon);
                    Log.d(TAG, "\n\n++++++++++ ️ℹ️ sending estimoteBeacon to Flutter, found: " + GSON.toJson(estimoteBeacon));
                    scanEvents.success(GSON.toJson(estimoteBeacon));
                } else {
                    Log.d(TAG, "onScanResult:  \uD83C\uDFBE this beacon has already been discovered");
                }
    ...
    private static HashMap<String, EstimoteBeacon> beaconHashMap = new HashMap<>();
