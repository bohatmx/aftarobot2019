...
public interface ProximityBeacon {
    ...
    /**
     * https://developers.google.com/beacons/proximity/reference/rest/v1beta1/beacons/delete
     */
    void deleteBeacon(Callback callback, String beaconName);
     ...
     */
    void registerBeacon(Callback callback, String beaconJSON);

    /**
     * https://developers.google.com/beacons/proximity/reference/rest/v1beta1/beacons/update
     */
    void updateBeacon(Callback callback, String beaconName, String beaconJSON);
     ...
     */
    void createAttachment(Callback callback, String beaconName, String attachmentJSON);
    ...
    /**
     * https://developers.google.com/beacons/proximity/reference/rest/v1beta1/namespaces/update
     */
    void updateNamespace(Callback callback, String namespace);
